...
class DevelopmentReportSpider(BaseSpider):
    ...
    def __init__(self):
        ...
        self.now_item_num = 0
        self.base_url = 'http://www.cbia.com.cn/index.php/Home/Infoforum/foruminfolist/code/AT14514466332FJ5?&page={page}'
        self.base_detail_url = 'http://www.cbia.com.cn/index.php/Home/Infoforum/infodetail/code/{code}'
        self.file_name = '中国轴承行业网_' + '发展报告' + '_' + self.now_day + '.txt'

...
class AnnouncementSpider(BaseSpider):
    name = 'bearing_cbia_announcement'
    handle_httpstatus_list = [301, 302, 204, 206, 404, 500]

    start_urls = [
        'http://www.cbia.com.cn/index.php/Home/Infoforum/foruminfolist/code/AT1451369985SRMY?&page=1'
    ]
    ...
    def __init__(self):
        ...
        self.now_item_num = 0
        self.base_url = 'http://www.cbia.com.cn/index.php/Home/Infoforum/foruminfolist/code/AT1451369985SRMY?&page={page}'
        self.base_detail_url = 'http://www.cbia.com.cn/index.php/Home/Infoforum/infodetail/code/{code}'
        self.file_name = '中国轴承行业网_' + '公告' + '_' + self.now_day + '.txt'
